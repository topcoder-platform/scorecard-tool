<%--
 ...
 - - set "NO" as default value for Document Upload 
 - - fixed direct links
 -
 - Version 1.2 (Release Assembly - TopCoder Scorecard Tool Ajax Loading and Static Files Sharing) Change notes:
 - - Fix typo of "Guideline"
 -
 - Version 1.3 ((TCCC-3917) Scorecard Tool - Document Upload Option) Change notes:
 ...
 -
  - Version 1.4 (Release Assembly - TC Group Management and Scorecard Tool Rebranding)
...
<html>
    ...
    <body>
        ...
        <input type="hidden" id="scorecard_id" value="${scorecardInstance.id}" />
        <div id="area1" class="scorecard"><!-- the main area -->
            ...
            <div class="areaHeader">
                <div class="expandCollapse editSaveScorecard">
                    <a class="button6 newButtonGreen saveChanges" href="#"><span class="left"><span class="right">SAVE CHANGES</span></span></a>
                    <a class="button6 newButtonOrange cancelChanges" href="${createLink(action:'show', id: scorecardInstance.id)}"><span class="left"><span class="right">CANCEL CHANGES</span></span></a>
                </div>
                <h2 class="title edit">Edit Scorecard</h2>
            </div><!-- End .areaHeader -->
            ...
            <div id="sortableGroups">
               <div id="sortableSections">
                   ...
                   <div class="biggroup" rel="${group.id}">
                           ...
                           <thead>
                               <tr>
                                   <th class="first">
                                       ...
                                       <strong>Group:</strong>&nbsp;&nbsp;<g:textField name="groupName" class="longText" value="${group.groupName}" />
                                   </th>
                                   <th colspan="4">
                                       <strong>Weight</strong>&nbsp;&nbsp;<g:textField name="groupWeight" class="shortText weightG" value="${group.weight}" />
                       ...
                       <div class="sections">
                           ...
                           <table class="scorecard view2 edit section" width="100%" cellpadding="0" cellspacing="0">
                               <tbody class="section">
                                   <tr class="section" rel="${section.id}">
                                       <td class="first">
                                           <div class="relative"><div class="move section"></div></div>
                                           <strong>Section:</strong>&nbsp;<g:textField name="sectionName" class="longText" value="${section.sectionName}" />
                                       </td>
                                       <td colspan="4">
                                           <strong>Weight:</strong>&nbsp;<g:textField name="sectionWeight" class="shortText weightS" value="${section.weight}" />
                                           <a class="remIcon" href="javascript:;"></a><a class="addIcon" href="javascript:;"></a>
                                       </td>
                                   </tr>
                                   ...
                                   <tr class="question" rel="${question.id}">
                                       <td class="first">
                                           <div class="relative"><div class="move question"></div></div>
                                           <p>Question Text:</p>
                                           <g:textArea name="questionDescription" cols="100" rows="2" class="question" value="${question.description}" />
                                           <p>Question Guideline</p>
                                           <g:textArea name="questionGuideline" cols="100" rows="7" class="guideline" value="${question.guideline}" />
                                       </td>
                                       <td>
                                           <g:select class="type edit" name="questionType" from="${questionTypes}" value="${question.questionType.id}" optionKey="id" optionValue="name" />
                                       </td>
                                       <td><g:textField name="questionWeight" class="shortText weightQ" value="${question.weight}" /></td>
                                       <td>
                                           <g:select value="${(question.uploadDocument ? (question.uploadDocumentRequired ? 'Required' : 'Optional') : 'N/A')}" 
                                                     from="${['N/A','Optional','Required']}" name="questionUploadDocument" />
                                       </td>
                                        ...
                                        <div class="container2BottomLeft"><div class="container2BottomRight">
                                            <div class="container2Content">
                                                ...
                                                <table class="projectStats contests" cellpadding="0" cellspacing="0" id="searchResult">
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            <th class="first">Scorecard Name&nbsp;&nbsp;<img src="${resource(dir:'images',file:'down.png')}" alt="" /></th>
                                                            <th>Type</th>
                                                            <th>Category</th>
                                                            <th>Status</th>
