<%--
 ...
 -
 - Description: This page renders the scorecard creating page.
 -
        ...
        <div id="area1" class="scorecard"><!-- the main area -->
            <div class="area1Content">
                <div class="currentPage">
                    ...
                    <strong>Create Scorecard</strong>
                </div>
            </div>
            <div class="areaHeader">
                ...
                <h2 class="title edit">Create Scorecard</h2>
            </div><!-- End .areaHeader -->
			...
			<th>Scorecard Version</th>
                ...
                <tbody>
                    <tr>
                        <td class="first"></td>
                        <td><g:textField name="scorecardName" class="mediumText" value="" /></td>
			<td><g:textField name="scorecardVersion" class="shortText" value="" /></td>
                        <td><g:select class="shortedit" name="projectType" from="${ProjectType.list()}" value="0" optionKey="id" optionValue="name" /></td>
                        <td><select class="shortedit" name="projectCategory" id="projectCategory"></select></td>
                        <td><g:select class="shortedit" name="scorecardType" from="${ScorecardType.list()}" value="0" optionKey="id" optionValue="name" /></td>
                        <td><g:textField name="minimumScore" class="shortText" value="" /></td>
                        <td><g:textField name="maximumScore" class="shortText" value="" /></td>
                        <td><g:select class="shortedit" name="scorecardStatus" from="${ScorecardStatus.list()}" value="0" optionKey="id" optionValue="name" /></td>
                    </tr>
                </tbody>
            </table>
            <br />
